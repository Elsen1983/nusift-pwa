...
export const useAgentStore = defineStore('agent', {
  state: () => ({
    ...
    // Központosított preferenciák
    topPreferences: [
      { id: 'ai_strategy', name: 'AI & Tech Strategy', weight: 85, icon: 'psychology' },
      { id: 'market_analysis', name: 'Market Analysis', weight: 60, icon: 'monitoring' },
