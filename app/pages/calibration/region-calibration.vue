<template>
  ...
  >
    ...
    <main
      class="mt-12 pt-6 pb-24 px-6 max-w-4xl mx-auto flex flex-col"
    >
      <section class="mb-4">
        <div
      ...
      <section class="mb-8 space-y-6">
        <div v-if="detectedCountry" class="mb-8">
          ...
          <button
            ...
            :disabled="isSaving"
            :class="[
              'w-full md:w-1/2 p-4 rounded-xl border transition-all duration-300 flex items-center gap-4 group text-left disabled:opacity-50 disabled:cursor-not-allowed',
          ...
          >
            <div
              class="w-10 h-10 rounded-full bg-surface-container-highest flex items-center justify-center text-primary-container shrink-0"
            >
        ...
        <div class="relative group" id="autocomplete-wrapper">
          ...
          >
            <input
              ...
              :disabled="isSaving"
              class="w-full bg-surface-container-highest border-none rounded-lg text-on-surface placeholder:text-outline/50 focus:ring-1 focus:ring-primary-fixed/30 font-body h-[52px] text-sm px-4 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div
          class="mt-4 p-4 rounded-2xl border border-outline-variant/10 bg-surface-container-lowest/50 text-sm text-on-surface-variant/80 italic font-light flex items-start gap-4"
        >
          <span
            class="material-symbols-outlined text-primary-container/60 shrink-0"
            >info</span
          >
          <p>
      ...
      <section class="flex flex-col items-end pt-2">
        <button
          ...
          class="flex items-center gap-3 px-6 py-3 rounded-xl transition-all group bg-gradient-to-br from-[#c3f5ff] to-[#00e5ff] text-[#131313] disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed"
        >
