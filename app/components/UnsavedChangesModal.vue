    ...
    <div v-if="isOpen" class="fixed inset-0 z-[200] flex items-center justify-center px-4">
      ...
      <div class="relative bg-[#1A1A1A] border border-white/10 w-full max-w-sm rounded-3xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-in fade-in zoom-in duration-300">
        <div class="flex flex-col items-center text-center">
          <div class="w-16 h-16 rounded-full bg-warning/10 flex items-center justify-center mb-6 border border-warning/20">
            <span class="material-symbols-outlined text-warning text-3xl">warning</span>
          </div>

          <h3 class="font-headline text-xl font-bold text-white mb-2 uppercase tracking-tight">Unsaved Changes</h3>
