<template>
  ...
  <div class="space-y-6">
    <!-- Identity Section -->
    <div class="bg-surface-container border border-outline-variant/10 rounded-2xl p-3 py-4 md:p-6 transition-[border-color,box-shadow] duration-200 hover:border-outline-variant/30 hover:shadow-sm">
