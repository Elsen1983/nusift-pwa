<template>
  ...
  >
    <div v-if="modelValue" class="fixed inset-0 z-[120] bg-black/80 backdrop-blur-sm flex items-center justify-center" @click.self="$emit('update:modelValue', false)">
...
defineEmits(['update:modelValue', 'browser', 'read']);
</script>